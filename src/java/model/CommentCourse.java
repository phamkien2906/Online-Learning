...
public class CommentCourse {
    ...
    public CommentCourse(User user, int commentc_id, int course_id, int user_id, String commentc_detail, Date commentc_date, int commentc_reply, int commentc_like, String commentc_image) {
        this.user = user;
        this.commentc_id = commentc_id;
        this.course_id = course_id;
        this.user_id = user_id;
        ...
        this.commentc_reply = commentc_reply;
        this.commentc_like = commentc_like;
        this.commentc_image = commentc_image;
    }
    ...
    public String getCommentc_image() {
        return commentc_image;
    }

    public void setCommentc_image(String commentc_image) {
        this.commentc_image = commentc_image;
    }
